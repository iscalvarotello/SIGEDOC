        ...
        <thead class="bg-gray-50 dark:bg-gray-800 sticky top-0 z-10">
          <tr>
            @for (col of columns(); track col.key) {
              <th 
                class="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-200 dark:border-gray-700"
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
          ...
          @for (item of data(); track item.id; let idx = $index) {
            <tr 
              ...
              [ngClass]="{
                'bg-[#691C32]/5 border-[#691C32] dark:bg-[#691C32]/20': isSelected(item),
