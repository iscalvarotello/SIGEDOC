...
export interface ActionBarAction {
  ...
  colorClass?: string; // Clase de borde al hacer hover, ej: 'hover:border-[#691C32]'
  iconColorClass?: string; // Clase de fondo/texto del circulo del icono, ej: 'bg-[#691C32]/10 text-[#691C32]'
  disabled?: boolean;
}
