  ...
  template: `
    <div class="flex flex-col ml-4 select-none">
      ...
      <div 
        ...
        [ngClass]="{
          'bg-[#691C32]/10 text-[#691C32] font-semibold border-l-4 border-l-[#691C32]': isSelected(),
        ...
        @if (hasChildren()) {
          <span 
            ...
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="w-3.5 h-3.5"><polyline points="9 18 15 12 9 6"></polyline></svg>
          </span>
        } @else {
        ...
        <span [ngClass]="{ 'text-[#691C32]': isSelected(), 'text-gray-400 dark:text-gray-500': !isSelected() }">
          @if (hasChildren()) {
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
          } @else {
            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="9" y1="9" x2="15" y2="9"></line><line x1="9" y1="13" x2="15" y2="13"></line><line x1="9" y1="17" x2="15" y2="17"></line></svg>
          }
        </span>
        ...
        <span class="text-sm truncate max-w-[240px]" [title]="node()[displayField()]">
          ...
          @if (badgeField() && node()[badgeField()]) {
            <span class="text-[10px] ml-1.5 px-1.5 py-0.5 rounded bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 group-hover:bg-[#691C32]/10 group-hover:text-[#691C32] transition-all">
              {{ node()[badgeField()] }}
            </span>
          }
        </span>
    ...
    <div class="flex flex-col gap-4 h-full">
      ...
      <div class="relative">
        <input 
          ...
          class="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-[#691C32]/30 focus:border-[#691C32] transition-all">
        <span class="absolute inset-y-0 left-3 flex items-center text-gray-400">
          <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
        </span>
      </div>
      ...
      <div class="flex-1 overflow-y-auto pr-1 flex flex-col gap-1 mt-1 border border-gray-50 dark:border-gray-800 rounded-lg p-2 bg-gray-50/50 dark:bg-gray-900/50">
        @if (isLoading()) {
          <div class="flex flex-col gap-3 py-10 items-center justify-center text-gray-500">
            <svg class="animate-spin h-6 w-6 text-[#691C32]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
