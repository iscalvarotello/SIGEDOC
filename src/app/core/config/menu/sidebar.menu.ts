    ...
    items: [
      {
        ...
        subItems: [
          { module_id: 17, name: "Memorandums", path: "/documento/memo", pro: false, new: false, value: 5 },
          { module_id: 18, name: "Oficios", path: "/documento/oficio", pro: false, new: false, value: 2 },
          { module_id: 19, name: "T. Inf.", path: "/documento/ti", pro: false, new: false, value: 3 },
          { module_id: 20, name: "Circulares", path: "/documento/circular", pro: false, new: false, value: 4 },
    ...
    items: [
      {
        ...
        subItems: [
          { module_id: 28, name: "Control de usuarios", path: "/database/security/users", pro: false },
          { module_id: 29, name: "Roles", path: "/database/security/roles", pro: false },
          // module_id: 30 fue eliminado (Módulos). No reasignar.
          { module_id: 31, name: "Permisos", path: "/database/security/permissions", pro: false }
        ],
      },
      {
        ...
        subItems: [
          { module_id: 32, name: "Generales", path: "/database/security/generales", pro: false },
          { module_id: 33, name: "Tipos de Documento", path: "/database/security/document-types", pro: false },
          { module_id: 34, name: "Plantillas", path: "/database/security/templates", pro: false },
          { module_id: 38, name: "Plantillas Internas", path: "/database/security/internal-templates", pro: false }
        ],
      }
    ]
  }
