...
export class AdscriptionDTO extends BaseDto<AdscriptionDTO> implements IBaseEntity {
  id!: string;
  is_head!: boolean;
  ...
  // Sucursal y ubicación (a través del área)
  branch?: string;
  city?: string;
  state?: string;
  country?: string;
  ...
  constructor(data: any = {}) {
    ...
    this.employee_id = data.employee_id || data.id_empleado || '';
