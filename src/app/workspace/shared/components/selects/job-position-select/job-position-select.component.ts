        ...
        @if (!disabled()) {
          <div class="inline-flex rounded-lg p-0.5 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-[10px] font-bold">
            <button 
              ...
              [ngClass]="{
                'bg-white dark:bg-gray-700 text-theme-primary dark:text-white shadow-sm': positionFilter() === 'principal',
            ...
            <button 
              ...
              class="px-2 py-1 rounded-md transition-all cursor-pointer"
              [ngClass]="{
                'bg-white dark:bg-gray-700 text-theme-primary dark:text-white shadow-sm': positionFilter() === 'operativo',
            ...
            <button 
              ...
              class="px-2 py-1 rounded-md transition-all cursor-pointer"
              [ngClass]="{
                'bg-white dark:bg-gray-700 text-theme-primary dark:text-white shadow-sm': positionFilter() === 'todos',
      ...
      <div class="flex items-center gap-1.5 w-full">
        <div class="relative flex-1">
          <select 
            ...
            class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-theme-primary/50 focus:border-theme-primary transition-all disabled:opacity-50 appearance-none cursor-pointer">
