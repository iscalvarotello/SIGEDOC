...
export class GeneralesService {
   ...
   */
  async updateSignatureSettings(payload: { active_provider_id?: string; offset_y: number; margin_x: number; legend_footnote?: string; legend_acuse?: string; }): Promise<any> {
    const url = `${this.baseUrl}/signatures/settings`;
  ...
  /**
   * Ejecuta el Super Seed en el backend.
   */
  async runSuperSeed(): Promise<any> {
    const url = `${this.baseUrl}/super-seed`;
