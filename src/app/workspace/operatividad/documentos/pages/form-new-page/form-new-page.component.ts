...
@Component({
  ...
  imports: [
    InputFieldComponent,
    TextAreaComponent,
    CcpFormPanelComponent, CommonModule, FormsModule, RouterLink, ClaseDocumentPipe, PageBreadcrumbComponent, AreaSelectComponent, DocumentTypeSelectComponent, DocumentAttachmentsComponent, DatePickerComponent, SubmitButtonComponent, CancelButtonComponent,
