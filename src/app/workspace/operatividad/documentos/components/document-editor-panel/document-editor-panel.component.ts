import { Component, OnInit, inject, signal, computed, effect, input, output, model, ViewChild } from '@angular/core';
...
@Component({
  ...
  imports: [
    ...
    CarSelectComponent, DatePickerComponent, RichEditorComponent
  ],
...
export class DocumentEditorPanelComponent implements OnInit {
  ...
  // Custom Fields (If any passed down, or managed here)
