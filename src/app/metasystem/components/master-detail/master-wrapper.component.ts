...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, SafeHtmlPipe, SvgIconPipe],
  template: `
    <div class="h-[calc(100vh-100px)] flex flex-col p-6 overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div class="flex justify-between items-center mb-6 flex-shrink-0">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white flex items-center gap-2">
          <span class="text-3xl flex w-8 h-8 items-center justify-center" *ngIf="icon()" [innerHTML]="icon() | svgIcon"></span> {{ title() }}
        </h1>
        <div class="flex gap-2">
          ...
          <button 
            ...
            class="bg-theme-primary hover:bg-[#521526] dark:bg-gray-900 dark:hover:bg-black text-white px-4 py-2 rounded-lg shadow-md font-medium transition-colors ml-2 flex items-center gap-1">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1 min-h-0 overflow-hidden">
        ...
        <div 
          ...
          <div class="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 flex-shrink-0 flex flex-col sm:flex-row gap-4 items-center">
            <div class="relative flex-1 w-full">
              ...
              <input 
                ...
                class="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-theme-primary/50 dark:bg-gray-900 dark:text-white transition-all shadow-sm"
              >
            </div>
          ...
          <div class="flex-1 overflow-auto relative p-4 lg:p-5">
            @if (serverError()) {
