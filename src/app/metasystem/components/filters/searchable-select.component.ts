  ...
  template: `
    <div class="relative w-full min-w-[220px]" [class.z-50]="isOpen()">
      ...
      <button 
        ...
        class="w-full relative flex items-center pl-10 pr-10 py-2.5 text-left border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-theme-primary focus:border-theme-primary sm:text-sm rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-sm transition duration-150 ease-in-out cursor-pointer"
      ...
      <div *ngIf="isOpen()" 
        ...
        <div class="sticky top-0 z-50 bg-white dark:bg-gray-800 px-2 py-2 border-b border-gray-100 dark:border-gray-700">
          <div class="relative">
            ...
            <input 
              ...
              class="w-full pl-9 pr-3 py-2 border border-gray-200 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-theme-primary/50 dark:bg-gray-700 dark:text-white transition-all shadow-sm"
              [ngModel]="searchTerm()"
        ...
        <ul class="flex-1 overflow-y-auto">
          <li *ngFor="let option of filteredOptions" 
              ...
              [class.bg-theme-primary/5]="option.id === value"
              [class.dark:bg-theme-primary/20]="option.id === value"
              [class.text-theme-primary]="option.id === value"
          ...
          >
            ...
            <span *ngIf="option.id === value" class="absolute inset-y-0 right-0 flex items-center pr-4 text-theme-primary dark:text-white">
