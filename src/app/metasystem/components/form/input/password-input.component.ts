...
export class PasswordInputComponent {
  ...
  get inputClasses(): string {
    ...
    if (this.disabled) {
      ...
      classes += ` bg-transparent text-gray-800 border-gray-300 focus:border-theme-primary focus:ring-theme-primary/20 dark:border-gray-700 dark:text-white/90 dark:focus:border-theme-secondary dark:focus:ring-theme-secondary/20`;
    }
    return classes;
  }
