...
import { FilterSupplierComponent } from '../../../../shared/components/filters/filter-supplier.component';
          ...
          @if (selectedItem()?.location) {
            <div class="mt-6 border-t border-gray-100 dark:border-gray-700 pt-4">
              <a [href]="selectedItem()?.location" target="_blank" rel="noopener noreferrer" 
                 class="flex items-center justify-center gap-2 w-full py-2.5 px-4 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 text-[#691C32] dark:text-[#BC955C] rounded-lg border border-gray-200 dark:border-gray-600 transition-colors font-medium text-sm">
