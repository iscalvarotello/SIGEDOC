  ...
  formConfig: [
    {
      ...
      fields: [
        { key: 'country_id', label: 'País de Pertenencia', type: 'api-select', required: true, placeholder: 'Seleccione un país...', apiConfig: { configKey: ENDPOINT_KEYS.COUNTRIES, labelKey: 'fullName', valueKey: 'id' }, gridSpan: 2 },
